...
if(isset($_SESSION['usr']) && isset($_SESSION['cod_usr'])){
   ...
   $resultado;
        if (isset($_GET['codigo'])) {
            ...
            $resultado = $clMto_editorial->eliminar_editorial($codigo);
            echo $resultado;
        }
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Añadir REGISTRO EDITORIAL   <a class="btn btn-primary btn-circle" href="editorial_nuevo.php"><i class="fa fa-plus"></i></a> 
                        </div>
                        ...
                        ?>
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                     ...
                                     <?php                                      
                                        $a_users = $clMto_editorial->get_editorial();
                                        foreach ($a_users as $row): ?>
                                            <tr>
                                                <td><?php echo $row['CODIGO_EDITORIAL']; ?></td>
                                                
                                                <td><?php echo $row['NOMBRE_EDITORIAL']; ?></td>
                                                <td><a href="editorial_nuevo.php?codigo=<?php echo $row['CODIGO_EDITORIAL']; ?>">Modificar</a></td>
                                                <td><a href="editorial_libros.php?codigo=<?php echo $row['CODIGO_EDITORIAL']; ?>">Eliminar</a></td>
                                            </tr><!-- /TROW -->                                    
                                    <?php endforeach ?>    
                                </table>
                            </div>
