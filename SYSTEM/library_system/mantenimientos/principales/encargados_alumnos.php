...
if(isset($_SESSION['usr']) && isset($_SESSION['cod_usr'])){
   ...
   $clMto_Encargado_Alumno = new mto_encargado_alumno();
   $mensaje = "";
   $mdl = new mensajes();
   $codigo = "";
   $resultado;
        if (isset($_GET['codigo'])) {
            ...
            $resultado = $clMto_Encargado_Alumno->eliminar_encargado($codigo);
            echo $resultado;
        }
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Añadir Encargado<a class="btn btn-primary btn-circle" href="encargados_alumnos_ingresar.php"><i class="fa fa-plus"></i></a> 
                        </div>
                        ...
                        ?>
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                     ...
                                     <?php                                      
                                        $a_alumnos = $clMto_Encargado_Alumno->get_encargados();
                                        foreach ($a_alumnos as $row): ?>
                                            <tr>
                                                <td><?php echo $row['CODIGO_ENCARGADO']; ?></td>
                                                <td><?php echo $row['NOMBRES_ENCARGADO']; ?></td>
