...
require_once "../../clases/vista/mensajes.php";
   ...
   $resultado;
        if (isset($_GET['codigo'])) {
            ...
            $resultado = $clMto_Usuario->eliminar_usuario($codigo);
            echo $resultado;
        }
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Añadir un usuario<a class="btn btn-primary btn-circle" href="usuario_ingresar.php"><i class="fa fa-plus"></i></a> 
                        </div>
                        ...
                        ?>
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                     ...
                                     <?php                                      
                                        $a_usuarios = $clMto_Usuario->get_usuario();
                                        foreach ($a_usuarios as $row): ?>
                                            <tr>
