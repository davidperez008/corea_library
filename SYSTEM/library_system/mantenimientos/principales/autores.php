...
if(isset($_SESSION['usr']) && isset($_SESSION['cod_usr'])){
   ...
   $resultado;
        if (isset($_GET['codigo'])) {
            ...
            $resultado = $clMto_autor->eliminar_autor($codigo);
            echo $resultado;
        }
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Añadir Autor    <a class="btn btn-primary btn-circle" href="autor_ingresar.php"><i class="fa fa-plus"></i></a> 
                        </div>
                        ...
                        ?>
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                     ...
                                     <?php                                      
                                        $a_users = $clMto_autor->get_autor();
                                        foreach ($a_users as $row): ?>
                                            <tr>
                                                <td><?php echo $row['CODIGO_AUTOR']; ?></td>
                                                
                                                <td><?php echo $row['NOMBRE_AUTOR']; ?></td>
                                                <td><a href="autor_ingresar.php?codigo=<?php echo $row['CODIGO_AUTOR']; ?>">Modificar</a></td>
                                                <td><a href="autores.php?codigo=<?php echo $row['CODIGO_AUTOR']; ?>">Eliminar</a></td>
                                            </tr><!-- /TROW -->                                    
                                    <?php endforeach ?>    
                                </table>
                            </div>
